...
public class Geofencing implements ResultCallback<Result> {
    ...
    public void registerAllGeofences() {
        ...
        try {
            LocationServices.GeofencingApi.addGeofences(mGoogleApiClient,
                    ...
                    getmGeofencPendingIntent()).setResultCallback(this);
    ...
    private PendingIntent getmGeofencPendingIntent() {
        if (mGeofencPendingIntent != null) {
            return mGeofencPendingIntent;
        }

        Intent intent = new Intent(context, GeofenceBroadcastReceiver.class);
        mGeofencPendingIntent = PendingIntent.getBroadcast(context,
